# 2026-02-21 19:12:33 by RouterOS 7.21.2
# software id = I7YI-49VA
#
# model = E60iUGS
...
add interface=ether1 name=vPPP vlan-id=100

/interface pppoe-client add add-default-route=yes comment="WAN - Eolo" disabled=no interface=vPPP name=pppoe-eolo user=""
...
/queue type
add kind=pcq name=PCQ-down pcq-classifier=dst-address pcq-rate=300M
add kind=pcq name=PCQ-up pcq-classifier=src-address pcq-rate=50M
...
add address=172.16.100.3 comment="JacopxMBP (trust)" mac-address="" server=dhcp-trust
add address=172.16.100.6 comment=MiddleEarth mac-address="" server=dhcp-trust
add address=172.16.100.4 comment=Rohan mac-address="" server=dhcp-trust
add address=172.16.100.5 comment=Isengard mac-address="" server=dhcp-trust
add address=172.16.100.2 mac-address="" server=dhcp-trust
add address=172.16.103.2 mac-address="" server=dhcp-other
add address=172.16.102.2 mac-address="" server=dhcp-console
add address=172.16.101.2 mac-address="" server=dhcp-computer
add address=172.16.103.3 comment=MinasMorgul mac-address="" server=dhcp-other
...
/ip dns set allow-remote-requests=yes cache-size=35000KiB servers=1.1.1.1,1.0.0.1,8.8.8.8,8.8.4.4

/ip dns adlist add url="https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/pro.plus.txt"
...
/system identity set name=Mordor

/system ntp client set enabled=yes

/system ntp server set broadcast=yes use-local-clock=yes
